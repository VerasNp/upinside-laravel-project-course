            ...
            <div class="col-md-8 col-md-offset-2 text-center">
                <div class="display-t">
                    <div class="display-tc animate-box" data-animate-effect="fadeIn">
                        ...
                        <h2>Com a metodologia e certificado da <a href="https://www.upinside.com.br" target="_blank">UpInside Treinamentos</a></h2>
                        <p><a class="btn btn-primary btn-lg btn-learn" href="{{ route('course') }}">Conhecer o Curso</a> <a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://vimeo.com/channels/staffpicks/93951774"><i class="icon-play"></i>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 text-center animate-box">
                <span class="fh5co-counter js-counter" data-from="0" data-to="13" data-speed="3000" data-refresh-interval="50"></span>
                <span class="fh5co-counter-label">Módulos</span>
            </div>
            <div class="col-md-3 text-center animate-box">
                <span class="fh5co-counter js-counter" data-from="0" data-to="82" data-speed="3000" data-refresh-interval="50"></span>
                <span class="fh5co-counter-label">Aulas</span>
            </div>
            <div class="col-md-3 text-center animate-box">
                <span class="fh5co-counter js-counter" data-from="0" data-to="16" data-speed="3000" data-refresh-interval="50"></span>
                <span class="fh5co-counter-label">Horas</span>
            </div>
            <div class="col-md-3 text-center animate-box">
                <span class="fh5co-counter js-counter" data-from="0" data-to="500" data-speed="3000" data-refresh-interval="50"></span>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-pull-8 animate-box">
                    <div class="mt">
                        ...
                        <p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://vimeo.com/channels/staffpicks/93951774"><i class="icon-play"></i> Assistir uma aula</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row bs-wizard animate-box" style="border-bottom:0;">
            ...
            <div class="col-xs-3 bs-wizard-step disabled">
                ...
                <a href="#" class="bs-wizard-dot"></a>
                <div class="bs-wizard-info text-center">
                    <p>Aplicando tudo o que aprendeu</p>
                </div>
            </div>
        </div>
