...
mix.sass(
    "resources/views/front/assets/sass/style.scss",
    ...
    .copyDirectory(
        "resources/views/front/assets/fonts",
        "public/front/assets/fonts"
    )
    .copyDirectory(
        "resources/views/front/assets/images",
        "public/front/assets/images"
    )
